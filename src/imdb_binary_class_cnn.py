...
# model constraint will cause the layer to pad or truncate sequences to exactly sequence_length values
...
model = tf.keras.Sequential([
    ...
    layers.Conv1D(filters=embedding_dim, kernel_size=3, padding='same', activation='relu'),
    layers.MaxPool1D(pool_size=2),
    layers.Bidirectional(tf.keras.layers.LSTM(100)),
...
=================================================================
embedding (Embedding)        (None, None, 64)          544000
_________________________________________________________________
